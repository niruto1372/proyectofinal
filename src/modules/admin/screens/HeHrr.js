...
import HEHrrTransformador from '../components/FormSingleAlarm/HEHrrTransformador'
...
const HeHrr = () => {
  ...
  const colors = { backgroundColor: 'rgba(255, 159, 64, 0.2)', borderColor: 'rgba(255, 159, 64, 1)'};
          ...
          <div className="row ml-0 mr-0 ">
            ...
            <div className="col-lg-3 col-md-4 col-sm-12  mx-auto">
              <div className="col-lg-12 col-md-12 col-sm-12  mx-auto">
                ...
                <HEHrrTransformador setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
