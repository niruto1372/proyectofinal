...
import HECarroCestaCarro2 from '../components/FormSingleAlarm/HECarroCestaCarro2'
          ...
          <div className="row ml-0 mr-0 ">
            ...
            <div className="col-lg-3 col-md-4 col-sm-12  mx-auto">
              <div className="col-lg-12 col-md-12 col-sm-12  mx-auto">
                ...
                <HECarroCestaCarro2 setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
