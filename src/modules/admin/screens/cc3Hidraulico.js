...
import CC3HidraulicoMolde from '../components/FormSingleAlarm/CC3HidraulicoMolde'
import CC3HidraulicoTanque from '../components/FormSingleAlarm/CC3HidraulicoTanque'
...
const CC3Hidraulico = () => {
  ...
  const colors = { backgroundColor:  'rgba(255, 99, 132, 0.2)', borderColor: 'rgba(255, 99, 132, 1)' };
          ...
          <div className="row ml-0 mr-0 ">
            ...
            <div className="col-lg-3 col-md-4 col-sm-12  mx-auto">
              <div className="col-lg-12 col-md-12 col-sm-12  mx-auto">
                <CC3HidraulicoMolde setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
                <CC3HidraulicoTanque setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
