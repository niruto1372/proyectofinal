...
import HECastilloPrincipal from '../components/FormSingleAlarm/HECastilloPrincipal'
...
const HeCastillo = () => {
  ...
  const colors = { backgroundColor: 'rgba(75, 192, 192, 0.2)', borderColor: 'rgba(75, 192, 192, 1)'};
          ...
          <div className="row ml-0 mr-0 ">
            ...
            <div className="col-lg-3 col-md-4 col-sm-12  mx-auto">
              <div className="col-lg-12 col-md-12 col-sm-12  mx-auto">
                <HECastilloPrincipal setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
              </div>
              <div className="col-lg-12 col-md-12 col-sm-12  mx-auto">
                {graficar === false ? null :
                  <div>
