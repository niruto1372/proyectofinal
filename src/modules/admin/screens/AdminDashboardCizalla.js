          ...
          <div className="row ml-0 mr-0 ">
            <div className="col-lg-3 col-md-3 col-sm-10  mx-auto">
              <div className="col  mx-auto">
                <CizallaCHDampers setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
              </div>
              <div className="col  mx-auto">
                <CizallaSisLimpiezaAglamper setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
              </div>

            </div>
            <div className="col-lg-9  col-md-9 col-sm-11    mx-auto">
              {graficar === false ? null :
                <div className="card">
                  <div className="card-body">
...
export default AdminDashboardCizalla
