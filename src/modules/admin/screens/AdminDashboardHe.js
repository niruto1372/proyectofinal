    ...
    <div className="wrapper">
      ...
      <div className="">
        <div className="content">
          <div className="row ml-0 mr-0 ">
            <div className="col-lg-3 col-md-3 col-sm-10  mx-auto">
              <HEHornoBoveda setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
            </div>
            <div className="col-lg-3 col-md-3 col-sm-10  mx-auto">
              <HECarroCestaCarro1 setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
            </div>
            <div className="col-lg-3 col-md-3 col-sm-10  mx-auto">
              <HECHAcumuladores setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
            </div>
            <div className="col-lg-3 col-md-3 col-sm-10  mx-auto">
              <HEHrrDucto setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
            </div>
          ...
          <div className="row  ml-0 mr-0">
            <div className="col-lg-11  col-md-1 col-sm-11    mx-auto">
              {graficar === false ? null :
                <div className="card">
                  <div className="card-body">
...
export default AdminDashboardHe
