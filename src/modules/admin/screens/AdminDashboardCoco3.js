...
import CC3MecanicoStroke1 from '../components/FormSingleAlarm/CC3MecanicoStroke1'
      ...
      <div className="">
        <div className="content">
          <div className="row ml-0 mr-0 ">
            ...
            <div className="col-lg-3 col-md-3 col-sm-10  mx-auto">
              <CC3MecanicoStroke1 setgraficar={setgraficar} setcurvaAconsultar={setcurvaAconsultar} obtenerVariable={obtenerVariable} />
            </div>
